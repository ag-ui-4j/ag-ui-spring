...
class SpringAiAgentTest {
    ...
    void carriesPriorAssistantToolCallsAndToolResultsIntoThePrompt() {
        ...
        var toolCall = new io.github.agui4j.core.message.ToolCall(
                "call-1", new io.github.agui4j.core.message.FunctionCall(
                        "setThemeColor", "{\"themeColor\":\"green\"}"));
        var assistant = new io.github.agui4j.core.message.AssistantMessage("a1", "", null, List.of(toolCall));
        var toolResult = new io.github.agui4j.core.message.ToolMessage(
